          ...
          <Pressable style={styles.customPickerBackdrop} onPress={() => setShowCustomPicker(false)}>
            <View style={styles.customPickerCard} onStartShouldSetResponder={() => true}>
              ...
              <input
                ...
                style={{ padding: 10, fontSize: 14, borderRadius: 8, border: '1.5px solid #E5E3DE', width: '100%', marginBottom: 12, fontFamily: 'inherit' } as any}
              />
              <Text style={styles.customPickerLabel}>End Date</Text>
              {/* @ts-ignore web-only */}
              <input
                ...
                style={{ padding: 10, fontSize: 14, borderRadius: 8, border: '1.5px solid #E5E3DE', width: '100%', marginBottom: 20, fontFamily: 'inherit' } as any}
              />
              <TouchableOpacity style={styles.customPickerApply} onPress={handleApplyCustom}>
...
const styles = StyleSheet.create({
  ...
  pillArrow: { fontSize: 9, color: '#B0ADA8' },
  ...
  optionLabelActive: { color: '#2D5BE3', fontWeight: '700' },
  optionSubLabel: { fontSize: 12, color: '#B0ADA8', marginTop: 2 },
  ...
  checkCircleText: { fontSize: 11, color: '#FFFFFF', fontWeight: '700', lineHeight: 14 },
