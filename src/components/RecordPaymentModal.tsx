...
export function RecordPaymentModal({ invoice, visible, onClose, onSuccess }: RecordPaymentModalProps) {
  ...
  // Auto-generate reference number when modal opens (only once)
  useEffect(() => {
    if (visible && !hasAutoGeneratedRef.current && !formData.reference_number) {
      const generatedRef = generatePaymentRef(formData.payment_date);
      setFormData(prev => ({ ...prev, reference_number: generatedRef }));
  ...
  const handleRegenerateRef = () => {
    const newRef = generatePaymentRef(formData.payment_date);
    setFormData(prev => ({ ...prev, reference_number: newRef }));
    userEditedRef.current = false;
  };

  const handleReferenceChange = (text: string) => {
    setFormData(prev => ({ ...prev, reference_number: text }));
        ...
        <View style={styles.modalContent}>
          ...
          <ScrollView style={styles.modalBody}>
            ...
            <View style={styles.labelRow}>
              ...
              <TouchableOpacity onPress={handleRegenerateRef} style={styles.regenerateButton}>
            ...
            <TextInput
              ...
              placeholder={formData.payment_method === 'Check' ? 'Check #' : 'Auto-generated or enter custom'}
            />
