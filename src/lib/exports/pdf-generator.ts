...
<head>
  ...
  <title>Schedule C Summary - ${taxYear} - Bozzy</title>
  <style>
    @media print {
      @page {
        size: letter;
...
<body>
  ...
  <div class="header">
    ...
    <div class="meta">
      Tax Year ${taxYear} • Generated by Bozzy on ${generatedDate}
    </div>
  </div>
  ...
  <div class="disclaimer">
    <strong>Important Disclaimer:</strong> This Schedule C Summary is generated by Bozzy for informational and planning purposes only. 
    ...
    Bozzy is not responsible for any tax-related decisions made based on this document.
  </div>

  <div class="footer">
    Generated by Bozzy • ${generatedDate} • Not for official IRS filing
  </div>
</body>
</html>
  `.trim();
...
export function downloadScheduleCHTML(input: PDFGeneratorInput, taxYear: number): void {
  ...
  link.setAttribute('download', `bozzy_${taxYear}_schedule_c_summary.html`);
