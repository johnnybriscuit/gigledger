...
-- These views provide clean, filtered data for CSV/Excel/PDF exports
-- All views respect RLS by filtering on user_id
...
-- RLS policy for gigs export view
...
SELECT 
  ...
  m.purpose,
  m.miles,
  -- IRS standard mileage rate for 2024 is $0.67/mile
  -- This should be configurable in the app
  ROUND(m.miles * 0.67, 2) AS deduction_amount,
  m.notes
FROM mileage m
ORDER BY m.date DESC;

-- RLS policy for mileage export view
...
-- RLS policy for payers export view
ALTER VIEW v_payers_export SET (security_invoker = on);

-- ============================================================================
-- 5. Schedule C Summary View
-- ============================================================================
-- This view aggregates expenses by Schedule C line items
-- Mapping is done in the application layer for flexibility
...
-- ============================================================================
-- Helper function to get tax year date range
-- ============================================================================
